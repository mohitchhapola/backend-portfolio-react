  ...
  const projects = [
    {
      ...
      details: 'Handles student management, attendance, grades, admissions, fee tracking, and reporting',
    ...
    },
    {
      ...
      details: 'Handles email notifications, batch processing, and background jobs',
      tags: ['Node.js', 'AWS SQS', 'Bull Queue', 'MongoDB'],
      link: '#',
      github: 'https://github.com/mohitchhapola',
    ...
    },
    {
      ...
      description: 'Building scalable and secure REST APIs for multiple projects',
      details: 'Authentication, authorization, error handling, and comprehensive documentation',
